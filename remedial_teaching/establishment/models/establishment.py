...
class EstablishmentGroup(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='created_establishments_groups', on_delete=models.SET_NULL, null=True, verbose_name=_("Created by"))
    ...
    last_update_by = models.ForeignKey(User, related_name='last_modified_establishments_groups', on_delete=models.SET_NULL, null=True, verbose_name=_("Last update by"))
...
class Establishment(models.Model):
    ...
    created_at = models.DateTimeField(_('Created at'), auto_now_add=True)
    created_by = models.ForeignKey(User, related_name='created_establishments', on_delete=models.SET_NULL, null=True, verbose_name=_("Created by"))
    email = models.CharField(_('Email'), blank=True, db_index=True, max_length=255, null=True)
    establishment_group = models.ForeignKey(EstablishmentGroup, related_name='establishments', on_delete=models.CASCADE, verbose_name=_("Establishment group"))
    ...
    is_deleted = models.BooleanField(_('Is deleted'), db_index=True, default=False)
    last_update_at = models.DateTimeField(_("Last update at"), auto_now_add=True)
    last_update_by = models.ForeignKey(User, related_name='last_modified_establishments', on_delete=models.SET_NULL, null=True, verbose_name=_("Last update by"))
    logo_url = models.CharField(_('Logo url'), blank=True, max_length=512, null=True)
...
class EstablishmentCycle(models.Model):
    ...
    created_at = models.DateTimeField(_('Created at'), auto_now_add=True)
    created_by = models.ForeignKey(User, related_name='created_establishments_cycles', on_delete=models.SET_NULL, null=True, verbose_name=_("Created by"))
    cycle = models.ForeignKey(Cycle, related_name='my_establishments', on_delete=models.PROTECT, verbose_name=_("Cycle"))
    establishment = models.ForeignKey(Establishment, related_name='my_cycles', on_delete=models.PROTECT, verbose_name=_("Establishment"))
    is_active = models.BooleanField(_('Is active'), db_index=True, default=True)
    last_update_at = models.DateTimeField(_("Last update at"), auto_now_add=True)
    last_update_by = models.ForeignKey(User, related_name='last_modified_establishment_cycles', on_delete=models.SET_NULL, null=True, verbose_name=_("Last update by"))
...
class EstablishmentUser(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='created_users_establishments_relationships', on_delete=models.SET_NULL, null=True, verbose_name=_("Created by"))
    ...
    establishment = models.ForeignKey(Establishment, related_name='users_relationships', on_delete=models.PROTECT, verbose_name=_("Establishment"))
    ...
    last_update_at = models.DateTimeField(_("Last update at"), auto_now_add=True)
    last_update_by = models.ForeignKey(User, related_name='last_modified_users_establishments_relationships', on_delete=models.SET_NULL, null=True, verbose_name=_("Last update by"))
    ...
    user = models.ForeignKey(User, related_name='establishments_relationships', on_delete=models.PROTECT, verbose_name=_("User"))
...
class ScholarYear(models.Model):
    ...
    created_at = models.DateTimeField(_('Created at'), auto_now_add=True)
    created_by = models.ForeignKey(User, related_name='created_scholar_years', on_delete=models.SET_NULL, null=True, verbose_name=_("Created by"))
    ...
    is_deleted = models.BooleanField(_('Is deleted'), db_index=True, default=False)
    last_update_at = models.DateTimeField(_("Last update at"), auto_now_add=True)
    last_update_by = models.ForeignKey(User, related_name='last_modified_scholar_years', on_delete=models.SET_NULL, null=True, verbose_name=_("Last update by"))
